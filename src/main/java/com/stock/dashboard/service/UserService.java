...
public class UserService {
    ...
    public void changePassword(String token, String verifyToken, String newPassword) {
    ...
    public void deleteAccount(String token, String verifyToken, String deleteReason) {
        if (verifyToken == null || verifyToken.isBlank()) {
            throw new RuntimeException("본인인증이 필요합니다.");
        }
        if (!jwtUtil.validateVerifyToken(verifyToken)) {
